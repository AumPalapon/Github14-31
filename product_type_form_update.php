...
<br><br>
<form id="form1" name="form1" method="POST" action="product_type_exec.php" >

<table width="70%" border="0" align="center">
    <tr>
        <td colspan="2" bgcolor="#D3D3D3">
            <center>ข้อมูลประเภทสินค้า</center>
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            ...
            <input type="hidden" name="product_type_id" id="product_type_id" value="<?php echo $product_type_id; ?>" placeholder="รหัสประเภทสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="product_type_name" id="product_type_name" placeholder="ประเภทสินค้า" value="<?php echo $product_type_name; ?>" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td colspan="2">
