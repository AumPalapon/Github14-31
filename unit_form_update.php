<?php
    ...
    while ($result_array = $query_result->fetch_assoc()) {
        $unit_id = $result_array['unit_id'];
        $unit_name = $result_array['unit_name'];
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<table width="70%" border="0" align="center">
    <tr>
        <td colspan="2" bgcolor="#D3D3D3">
            <center>ข้อมูลหน่วยนับสินค้า</center>
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <?php echo $unit_id; ?>
            <input type="hidden" name="unit_id" id="unit_id" value="<?php echo $unit_id; ?>" placeholder="รหัสหน่วยนับสินค้า" autocomplete="off" class="form-control input-lg" >
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="unit_name" id="unit_name" value="<?php echo $unit_name; ?>" placeholder="หน่วยนับสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td colspan="2">
