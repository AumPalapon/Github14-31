...
<table width="70%" border="0" align="center">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="unit_id" id="unit_id" placeholder="รหัสหน่วยนับสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="unit_name" id="unit_name" placeholder="หน่วยนับสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td colspan="2">
