...
<?php
    if($_POST['chk'] == "insert"){
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            echo "<center><a href='product_show.php'><h5>ไม่สามารถบันทึกข้อมูลได้</h5></a></center>";
        } 
        $conn->close();
    }
?>
<?php
    if($_GET['chk'] == "delete"){
      ...
      if ($conn->query($sql) === TRUE) {
        ...
        echo "<center><a href='product_show.php'><h5>ไม่สามารถลบข้อมูลได้</h5></a></center>";
      } 
      $conn->close();
    }
?>
<?php
  if($_POST['chk'] == "update"){
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<center><a href='product_show.php'><h5>ไม่สามารถแก้ไขข้อมูลได้</h5></a></center>";
    } 
    $conn->close();
 }
?>
