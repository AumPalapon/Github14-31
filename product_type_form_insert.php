...
<table width="70%" border="0" align="center">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="product_type_id" id="product_type_id" placeholder="รหัสประเภทสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="product_type_name" id="product_type_name" placeholder="ประเภทสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td colspan="2">
