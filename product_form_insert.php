...
<table width="70%" border="0" align="center">
    ...
    <tr>
        ...
        <td>
            <input type="text" name="product_id" id="product_id" placeholder="รหัสสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="product_name_th" id="product_name_th" placeholder="ชื่อสินค้าภาษาไทย" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="product_name_en" id="product_name_en" placeholder="ชื่อสินค้าภาษาอังกฤษ" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <textarea name="product_detail" id="product_detail" placeholder="รายละเอียดสินค้า" autocomplete="off" class="form-control input-lg" rows="3"></textarea>
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="number" name="product_number" id="product_number" placeholder="จำนวนสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
...
?>
    ...
    <tr>
        ...
        <td>
            <input type="date" name="product_start_date" id="product_start_date" placeholder="วันที่ผลิตสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="date" name="product_exp_date" id="product_exp_date" placeholder="วันที่สินค้าหมดอายุ" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td bgcolor="#D3D3D3">
        ...
        <td>
            <input type="text" name="product_price" id="product_price" placeholder="ราคาสินค้า" autocomplete="off" class="form-control input-lg">
        </td>
    </tr>
    <tr>
        <td colspan="2">
