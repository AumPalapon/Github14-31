...
<?php 
    ...
    if(isset($_SESSION['user_fname'])){ unset($_SESSION["user_fname"]); }
    if(isset($_SESSION['user_lname'])){ unset($_SESSION["user_lname"]); }

    echo "<br><br><br><center><h5>คุณออกจากระบบแล้ว <br><br> ขอบคุณที่ใช้บริการ</h5></center>";
